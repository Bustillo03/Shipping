...
public class Calculation {
	...
	public void addItems(Item item, int quantity) {
		...
		// Add the corresponding containers to the list
		Container container;
		if (item.calculateVolume() >= getBigContainerVolume()) {
	...
	public double calculateShippingPrice() {
		...
		// Calculate the shipping price based on the number of containers and their
		// costs
